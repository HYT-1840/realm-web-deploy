...
# ========== 版本信息配置区 ==========
SCRIPT_NAME="Realm Web Rust 管理脚本"
VERSION="v1.2.0"
RELEASE_DATE="2026-01-31"
AUTHOR="HYT-1840"
DESCRIPTION="Realm端口转发面板 Rust 重构版，兼容Caddy 2.10+"
# ===================================
...
show_version() {
    echo "================================================================"
    echo -e "           ${SCRIPT_NAME}"
    echo -e "           版本: ${VERSION}  |  更新: ${RELEASE_DATE}"
    echo -e "           作者: ${AUTHOR}  |  ${DESCRIPTION}"
    echo "================================================================"
}

# 初始化日志
touch /var/log/realm-web-deploy.log
log "===== ${SCRIPT_NAME} ${VERSION} 启动 ====="
